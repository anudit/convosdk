...
class Auth extends base_1.default {
    constructor(apikey) {
        ...
        this.validate = (signerAddress, token) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { data } = yield axios_1.default.post(`${this.base}/validateAuth?apikey=${this.apikey}`, {
                    signerAddress,
                    token,
                });
                return data;
        ...
        this.authenticate = (signerAddress, signature, timestamp, chain, accountId) => __awaiter(this, void 0, void 0, function* () {
            try {
                if (chain === 'ethereum') {
                    const { data } = yield axios_1.default.post(`${this.base}/auth?apikey=${this.apikey}`, {
                        signerAddress,
                        signature,
                        timestamp,
                        chain,
...
},{"./base":32,"axios":2}],32:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
class ConvoBase {
    constructor(apikey) {
        ...
        this.ping = () => __awaiter(this, void 0, void 0, function* () {
            try {
                const { data } = yield axios_1.default.get(`${this.base}/ping`);
                return data;
            }
            catch (error) {
                if (axios_1.default.isAxiosError(error)) {
...
const axios_1 = __importDefault(require("axios"));
const base_1 = __importDefault(require("./base"));
class Comments extends base_1.default {
    constructor(apikey) {
        super(apikey);
        this.create = (signerAddress, token, comment, threadId, url) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { data } = yield axios_1.default.post(`${this.base}/comments?apikey=${this.apikey}`, {
                    token,
                    signerAddress,
                    comment,
                    threadId,
        ...
        this.delete = (token, commentId) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { data } = yield axios_1.default.delete(`${this.base}/comments?apikey=${this.apikey}`, {
                    data: {
                        token,
                        commentId,
                    },
...
},{"./base":32,"axios":2}],34:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
const axios_1 = __importDefault(require("axios"));
const base_1 = __importDefault(require("./base"));
class Identity extends base_1.default {
    constructor(apikey) {
        super(apikey);
        this.getTrustScore = (address) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { data } = yield axios_1.default.get(`${this.base}/identity?address=${address}&apikey=${this.apikey}`);
                return data;
            }
            catch (error) {
                if (axios_1.default.isAxiosError(error)) {
...
},{"./base":32,"axios":2}],35:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
class Convo extends base_1.default {
    constructor(apikey) {
        super(apikey);
        this.comments = new comments_1.default(apikey);
        this.auth = new auth_1.default(apikey);
        this.threads = new threads_1.default(apikey);
        this.identity = new identity_1.default(apikey);
        return this;
    }
}
exports.default = Convo;

},{"./auth":31,"./base":32,"./comments":33,"./identity":34,"./threads":36}],36:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
const base_1 = __importDefault(require("./base"));
class Threads extends base_1.default {
    constructor(apikey) {
        super(apikey);
        return this;
    }
