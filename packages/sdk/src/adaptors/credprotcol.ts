...
export default async function getCredProtocolData(address: string): Promise<CredResult | false> {
  try {
...
export const CredprotocolAdaptorDeets: AdaptorDeets = {
  ...
  name: 'Cred Protocol',
  projectThumbnail:
    'ipfs://bafybeigvespcfammsvpt7vizeohwdjyyolacppgmm4jchuqtn36v62cnxm/credprotcol.webp',
